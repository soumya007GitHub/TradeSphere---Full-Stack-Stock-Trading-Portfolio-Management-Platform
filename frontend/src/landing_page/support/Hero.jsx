...
const Hero = () => {
    return (
        <section className="flex flex-col justify-between items-center bg-blue-500 pt-20 text-white px-5 md:px-10 lg:px-48 w-full" id="supportHero">
            <div className="m-3 w-full gap-6 flex flex-col md:flex-row justify-between">
                <div className="w-full md:w-1/2 p-3 flex flex-col items-start justify-between">
                    <h4 className="text-2xl font-bold">Support Portal</h4>
                    <h5 className="fs-3">
                        Search for an answer or browse help topics to create a ticket
                    </h5>
                    <input placeholder="Eg. how do I activate F&O" className='bg-white rounded text-gray-900 px-4 py-3 w-[70%] md:w-1/2 my-2' disabled />
                    <br />
                ...
                <div className="w-full md:w-1/2 p-3 flex flex-col items-start ">
